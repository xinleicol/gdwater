...
export default class XLVadoseBox extends XLCommonBox{
    ...
    gennerate(offset){
        ...
        this._computerBox();
        let xlGeo = new XLBoxGeometry(this.vadoseCenter, this.vadoseDimensions);
        xlGeo.initBoxPosition3DUpdate(offset, this._lengthNum, this._widthNum, this._depthNum);
        xlGeo.boxEntitiesStyle.showOutline = true;
        xlGeo.boxEntitiesStyle.changeOutlineColor = Cesium.Color.BLACK;
