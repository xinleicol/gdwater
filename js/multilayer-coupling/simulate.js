...
function initGdwaterCell() {
    gdwaterLevelCell = new GdwaterLevelCell(waterLevel, waterVeloty, gdwaterRows, gdwaterCols, dimensions)
...
function particleDiffusion(currentPollutedGrid, nextPollutedArea) {
    for (let j = 0; j < nextPollutedArea.length; j++) {
        ...
        // }
        xlPar.particleSimulate(nextPollutedArea[j], surfaceCell.spreadArea, vadoseZoneCell.spreadArea, gdwaterLevelCell.spreadArea);
    }
